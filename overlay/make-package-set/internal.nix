...
let
  ...
  packageFunWith = { mkRustCrate, buildRustPackages }: lib.fix (rustPackages: packageFun {
    inherit rustPackages buildRustPackages lib workspaceSrc target profileOpts codegenOpts cargoUnstableFlags rustcLinkFlags rustcBuildFlags ignoreLockHash cargoConfig registries;
...
packageFunWith { mkRustCrate = mkRustCrate'; buildRustPackages = buildRustPackages'; } // {
  inherit rustPackages callPackage pkgs rustToolchain noBuild registries;
